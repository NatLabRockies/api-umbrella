...
local AgentLoopEvent = model_ext.new_class("agent_loop_events", {
  as_json = function(self)
    return {
      ...
      score = json_null_default(tonumber(self.score)),
      grade_label = json_null_default(self.grade_label),
      responsibility_tier = json_null_default(self.responsibility_tier),
      reputation_delta = json_null_default(tonumber(self.reputation_delta)),
      asset_value_delta = json_null_default(tonumber(self.asset_value_delta)),
